...
const ChatUser = ({user}) => {
  ...
  if(user)
  return (
    <div className='flex flex-col items-center justify-start rounded-r-xl gap-5 py-5 px-10 col-span-1 h-[45rem] border-l-2 border-l-[#c0bdad] overflow-y-scroll bg-[#f1f0e1]'>
      ...
      <p className='font-light text-xl mt-5'>{user.description}</p>
    </div>
  )
  else return (
