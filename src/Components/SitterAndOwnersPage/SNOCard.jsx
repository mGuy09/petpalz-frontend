  ...
  if (isPetSitter)
    ...
    return (
      <div className="bg-white flex flex-col gap-5 w-[32%] p-5  shadow-lg">
        <div className="flex gap-20">
          <div className="w-[5rem] h-[5rem] hover:scale-110 text-white/0 duration-200 flex items-center justify-center bg-[#b1aea0] rounded-full shadow-md">
            d
          </div>
        ...
        <div className="w-full h-[2px] bg-[#c4c0b1] "></div>
        <div className="flex flex-col gap-4 h-[50%] p-5">
          <h1 className="font-medium text-lg underline rounded-md bg-[#cecbc0] animate-pulse text-white/0 underline-offset-[3px]">
            Description
          </h1>

          <div className="overflow-hidden h-[20rem] relative text-white/0 rounded-md bg-[#cecbc0] animate-pulse font-light whitespace-pre-line w-full">
          ...
          <div className="flex invisible justify-between px-5">
