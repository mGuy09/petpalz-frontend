  ...
  return (
    <div className="relative h-[100vh]">
      ...
      <div
        ...
        className={`top-[13%] left-[32%] flex absolute flex-col group items-center w-[45rem] h-[40rem] rounded-2xl  justify-center duration-200 gap-11  ${click
      ...
      >
        <div className="flex flex-col gap-4 items-center">
          <h1
            className={`text-3xl font-medium  duration-200 ${click ? "text-[#E84855] drop-shadow-md" : "text-white"
              }`}
          >
            Sign In
          </h1>
          <div
            className={`w-[12rem] h-[.20rem] rounded-full  ${click ? "bg-[#e84855] drop-shadow-md" : "bg-white"
              }`}
          ></div>
        </div>
        <div className="flex gap-4">
          <button
            className={`border-2 text-white p-2 shadow-md shadow-black/5 duration-200 rounded-full  ${click
          ...
          <button
            className={`border-2  p-2 shadow-md shadow-black/5 duration-200 rounded-full text-white ${click
                ? "bg-[#fa5437] hover:bg-[#a82c16] border-transparent"
                : "border-white"
              }`}
          >
        ...
        <div className="flex flex-col items-center gap-4">
          <p className={`flex items-center gap-2 select-none  ${error ? 'text-red-500/100' : 'text-transparent'}`}><AiOutlineExclamationCircle /> Incorrect Username or Password</p>
          ...
          <Link
            to={""}
            className={`duration-200 font-medium ${click
        ...
        <div className="flex flex-col gap-3 items-center">
          <button
            onClick={Submit}
            className={`flex gap-2 items-center px-4 py-2 font-medium border-2 duration-200 rounded-full  shadow-md shadow-black/5  ${click
